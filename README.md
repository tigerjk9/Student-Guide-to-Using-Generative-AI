...
- 💾 **자동 저장** — 진단 결과·약속 체크 상태를 `localStorage`에 보관 (서버 전송 0)
- 📦 **단일 파일** — `index.html` 하나. 빌드 도구·서버·외부 이미지 없이 어디서나 바로 실행
- ♿ **접근성** — 큰 글자 · 넓은 터치 타깃 · `aria` 라벨 · 키보드 접근
...
- **🩺 자가진단 퀴즈** — 20문항(각 1~4점)에 답하면 80점 만점으로 합산, 점수에 따라 🟢 잘 활용 / 🟡 의존 시작 / 🔴 도움 필요 밴드를 안내 (56점 이상이면 109·1388 강조)
