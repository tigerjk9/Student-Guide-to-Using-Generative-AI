...
[![▶ LIVE DEMO](https://img.shields.io/badge/▶%20LIVE%20DEMO-바로%20열기-FF6B9D?style=for-the-badge&labelColor=000)](https://tigerjk9.github.io/Student-Guide-to-Using-Generative-AI/)
...
![Pretendard](https://img.shields.io/badge/Pretendard-000000?style=for-the-badge&logoColor=white)

![Single File](https://img.shields.io/badge/Single_File-1_HTML-FFD93D?style=flat-square&labelColor=000)
![No Build](https://img.shields.io/badge/No_Build-CDN_only-4ECDC4?style=flat-square&labelColor=000)
![Design](https://img.shields.io/badge/Design-Neo--brutalism-B388FF?style=flat-square&labelColor=000)
![Use](https://img.shields.io/badge/Use-교육용-B8E986?style=flat-square&labelColor=000)
...
- 🔠 **글자 크기 3단계** — 저시력·저학년 배려, 선택은 자동 저장
- 🧩 **인터랙티브** — 점수형 자가진단 · 저장형 약속 체크리스트 · 복사형 프롬프트
- 🔗 **QR · 링크 공유** — QR이나 링크로 교실에 바로 배부
- 💾 **자동 저장** — 진단 결과·약속·언어·글자 크기를 `localStorage`에 보관 (서버 전송 0)
...
- **🌐 한/영 토글 · 🔠 글자 크기** — 헤더 컨트롤로 즉시 전환, 선택은 자동 저장
- **🔗 QR · 링크 공유** — QR·링크로 교실·학급에 바로 배부
